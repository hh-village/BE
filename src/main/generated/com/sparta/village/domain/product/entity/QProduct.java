...
public class QProduct extends EntityPathBase<Product> {
    ...
    private static final long serialVersionUID = 1020644645L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProduct product = new QProduct("product");

    public final com.sparta.village.domain.reservation.entity.QTimestamped _super = new com.sparta.village.domain.reservation.entity.QTimestamped(this);
